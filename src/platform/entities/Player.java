...
public abstract class Player {
    ...
    public Player(String name, Color color) {
        ...
        this.roadsBuilt=0;
        for(int i=0;i<10;i++) {
            addRessource(Ressources.LUMBER);
            addRessource(Ressources.BRICK);
            addRessource(Ressources.WHEAT);
            addRessource(Ressources.SHEEP);
            addRessource(Ressources.ORE);
        }
    }
